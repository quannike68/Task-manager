        ...
        <div>
            ...
            <Modal
                ...
                <div className='space-y-4 h-[60vh] overflow-y-auto '>
                    {allUser.map((user) => (
                        <div className='flex items-center gap-4 p-3 border-b border-gray-200' key={user._id}>
                            <img src={user.profileImageUrl ? user.profileImageUrl : default_avatar}
                                alt={user.name}
                ...
                <div className='flex justify-end gap-4 pt-4'>
                    <button className='card-btn' onClick={() => { setIsModalOpen(false); setTempSelectUsers([]) }}>Cancel</button>
