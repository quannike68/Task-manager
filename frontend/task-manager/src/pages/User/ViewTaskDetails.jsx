...
const ViewTaskDetails = () => {
  ...
  return (
    <DashboardLayout activeMenu="My Tasks">
      <div className="mt-5">
        {task && (
          <div className="gird gird-cols-1 md:gird-cols-4 mt-4">
            <div className="form-card col-span-3">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`md:text-[13px] text-[11px] font-medium ${getStatusTagColor(
                    task?.status
                  )} px-4 py-1.5 rounded `}
                >
                  {task?.status}
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div
      onClick={onClick}
      className="flex justify-between items-center bg-gray-50 border border-gray-100 px-3 py-2 rounded-md cursor-pointer hover:bg-gray-100 transition"
    >
